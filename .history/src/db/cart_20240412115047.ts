...
import { CartPrModel } from '../../.history/src/db/cart_product_20240411142210';
...
export const createCart = (value: CartPrModel) => new CartModel(values).save().then((cart) => cart.toObject())
