        ...
        async (userId) => {
            ...
            for (var productItem of products) {
                ...
                if (orders.length === 0) {
                    ...
                    const isShopExist = orders.find(order => order.shopId === productItem.shopI);

                    console.log('ORDER: ' + currentShopId);
                    console.log('ORDER: ' + isShopExist);
                    console.log('ORDER: ' + order.shopId );

                    if (isShopExist) {
                        console.log('ORDER: ' + 'item already exist');
